...
from prompt_toolkit.document import Document, _FIND_BIG_WORD_RE
    ...
    def get_completions(
        ...
        # No space in the input: behave exactly like `WordCompleter`.
            ...
            completer = WordCompleter(
                list(self.options.keys()), ignore_case=self.ignore_case, pattern=_FIND_BIG_WORD_RE # use big words instead
            )
